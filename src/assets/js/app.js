...
(function ($) {
    ...
    if ($('.client-testimonial-1') && $('.client-testimonial-1').length > 0) {
    ...
    if ($('.coins_pack_carousel') && $('.coins_pack_carousel').length > 0) {
        $('.coins_pack_carousel').owlCarousel({
            loop: false,
            nav: true,
            dots: false,
            margin: 10,
    ...
    } // 10. coins_pack_carousel carousel

    if ($('.single_testimonial') && $('.single_testimonial').length > 0) {
        $('.single_testimonial').owlCarousel({
            loop: true,
            nav: false,
            dots: true,
            responsiveClass: true,
    ...
    if ($('.client-testimonial-2') && $('.client-testimonial-2').length > 0) {
    ...
    if ($('.hero-slider-one') && $('.hero-slider-one').length > 0) {
