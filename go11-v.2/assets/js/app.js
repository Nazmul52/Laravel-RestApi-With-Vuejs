...
jQuery(function ($) {
  ...
  if ($('.client-testimonial-1').length > 0) {
  ...
  if ($('.coins_pack_carousel').length > 0) {
  ...
  if ($('.single_testimonial').length > 0) {
  ...
  if ($('.client-testimonial-2').length > 0) {
